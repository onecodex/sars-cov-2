...
def parse_args():
    ...
    parser.add_argument(
        'bedfile',
        help='Amplicon insert regions bedfile path'
    )
    parser.add_argument(
        'alignments',
        help='Alignments .bam path'
    )
    parser.add_argument(
        '--prop_cov',
...
def run(args):
    ...
    df = pd.read_csv(b, sep="\t", header=None, names=['chrom',
                                                      'chrom_start',
                                                      'chrom_end',
                                                      'region_name',
                                                      'primer_pool',
    ...
    insert_stats_df = insert_stats_df[['insert_name', 
                                       'insert_length', 
                                       'mean', 
                                       'std', 
                                       'min', 
